...
const TECH_LOGOS: TechLogo[] = [
    ...
    },
    {
        ...
        color: "#ffffff",
        label: "Prisma",
        icon: "https://cdn.simpleicons.org/prisma/0C4A6E",
        shape: "rounded",
    },
    {
        name: "PlanetScale",
        ...
        color: "#ffffff",
        label: "PlanetScale",
        icon: "https://cdn.simpleicons.org/planetscale/007ACC",
        shape: "hex",
    },
    {
        name: "Clerk",
        ...
        color: "#ffffff",
        label: "Clerk",
        icon: "https://cdn.simpleicons.org/clerk/030A19",
        shape: "rounded",
    },
    {
        name: "Resend",
        ...
        color: "#ffffff",
        label: "Resend",
        icon: "https://cdn.simpleicons.org/resend/0A2540",
        shape: "circle",
    },
    {
        name: "Lemon Squeezy",
        ...
        color: "#ffffff",
        label: "Lemon Squeezy",
        icon: "https://cdn.simpleicons.org/lemonsqueezy/635BFF",
        shape: "rounded",
    },
];
